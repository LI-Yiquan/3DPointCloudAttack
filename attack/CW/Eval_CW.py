...
def attack():
    ...
    return all_adv_pc, all_real_lbl, all_target_lbl, num, trans_num
...
if __name__ == "__main__":
    ...
    # run attack
    attacked_data, real_label, target_label, success_num, trans_num = attack()

    # accumulate results
    data_num = len(test_set)
    success_rate = float(success_num) / float(data_num)
    trans_rate = float(trans_num) / float(success_num)
