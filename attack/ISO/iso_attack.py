...
if __name__ == '__main__':
    ...
    """
    if args.model == 'PointNet':
        model = PointNetCls(k=105, feature_transform=False)
    elif args.model == 'PointNet2_MSG':
        model = PointNet_Msg(105, normal_channel=False)
    elif args.model == 'PointNet2_SSG':
        model = PointNet_Ssg(105)
    elif args.model == 'DGCNN':
    ...
    model.load_state_dict(
        torch.load(os.path.expanduser(os.path.expanduser(
            '~//yq_pointnet//cls//PointNet_model_120_416.pth'))))
