...
from attack.Gen3DAdv.ObjectAdd_attack  import CWAddObjects
...
if __name__ == "__main__":
    ...
    attacker = CWAddObjects(model=model, trans_model=trans_model,adv_func=adv_func, dist_func=dist_func,
