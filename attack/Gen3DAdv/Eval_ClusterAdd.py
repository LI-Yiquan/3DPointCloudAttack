...
from attack.Gen3DAdv.ClusterAdd_attack  import CWAddClusters
from attack.Gen3DAdv.utils.adv_utils import CrossEntropyAdvLoss, LogitsAdvLoss, UntargetedLogitsAdvLoss
from attack.Gen3DAdv.utils.dist_utils import L2Dist, ClipPointsLinf, FarChamferDist
...
if __name__ == "__main__":
    ...
    attacker = CWAddClusters(model=model, trans_model=trans_model,adv_func=adv_func, dist_func=dist_func,
